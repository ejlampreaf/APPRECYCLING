    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.imgbuttonpapelsi:
                ...
                datosimg = R.drawable.elementospapelsi;
                break;
            ...
            case R.id.imgbuttonplasticosi:
                ...
                datosimg = R.drawable.elementoplasticosi;
                break;
            case R.id.imgbuttonplasticono:
                ...
                datosimg = R.drawable.elementoplasticono;
                break;
            case R.id.imgbuttonvidriosi:
                ...
                datosimg = R.drawable.elementovidriosi;
                break;
            case R.id.imgbuttonvidriono:
                ...
                datosimg = R.drawable.elementovidriono;
                break;
            case R.id.imgbuttonmetalsi:
                ...
                datosimg = R.drawable.elementometalsi;
                break;
            case R.id.imgbuttonmetalno:
                ...
                datosimg = R.drawable.elementometalno;
                break;
        }
